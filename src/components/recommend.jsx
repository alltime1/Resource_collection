...
export default class Mine extends Component {
  constructor(props) {
    ...
    this.state = {
      bookList: [
        {
          img: "http://1.116.252.29/logo.png",
          text: "书栈网 · BookStack_程序员IT互联网开源编程书籍免费阅读与下载，取之于猿用之于猿",
          path: "https://www.bookstack.cn/"
        }, {
          img: "http://1.116.252.29/pinned-octocat.svg",
          text: "GitHub",
          path: "https://github.com"
        }, {
          img: "http://1.116.252.29/juejin.svg",
          text: "掘金",
          ...
          img: "http://1.116.252.29/vLogo.svg",
          text: "vue 中文文档",
          path: "https://cn.vuejs.org/"
        }, {
          img: "http://1.116.252.29/angularL.svg",
          text: "angular 官方文档",
  ...
  componentDidMount() {
    ...
    for (let i = 0; i < this.state.bookList.length; i++) {
      ...
      createImg.src = this.state.bookList[i].img;
      let height = 200;
      let width = 200;
      ...
      createImg.onload = () => {
        if (createImg.height > createImg.width) {
          ...
          createImg.style.width = "200" + "px";
          console.log(createImg.width, createImg.height)
          height = createImg.height / (createImg.width / 200)
          createImg.style.height = "auto"
        }
        this.createCanvas(createImg, width, height, ctx)
  ...
  createCanvas(createImg, width, height, ctx) {
    ...
    let cData = ctx.getImageData((200 - width) / 2, (200 - height) / 2, width, height);
    ...
    return (
      <div className={style.book_list} ref={this.canvasRef} >
        {this.state.bookList.map((e, i) => {
          return (
            <Tooltip placement="top" title={e.path}>
